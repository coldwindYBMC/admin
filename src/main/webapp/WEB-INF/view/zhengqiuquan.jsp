...
<body>
	<form action="${pageContext.request.contextPath}/excelUpdate.do" method="post">
		...
		<label><input name="resoure" type="checkbox" value="12" />coliseume</label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
		&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
		<label><input name="resoure" type="checkbox" value="13" />简体os_s_1.5.4</label>
		...
		<label><input name="excel" type="radio" value="10" />cross_battle</label>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
		<label><input name="excel" type="radio" value="9" />简体os_s_1.5.4 </label> 
